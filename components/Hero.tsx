import { GithubIcon, HomeIcon, LucideHome, Wifi, Zap } from "lucide-react";
        ...
        <div className="flex flex-col gap-5">
          <div className="relative flex flex-col gap-5">
            <div
              ...
              className="absolute left-1/2 top-1/2 -z-10 mx-auto size-[800px] rounded-full border p-16 mask-[linear-gradient(to_top,transparent,transparent,white,white,white,transparent,transparent)] md:size-[1300px] md:p-32"
            >
            ...
            <div className="flex flex-col items-center justify-center gap-3 pb-12 pt-3">
              <div className="flex gap-2">
                <Button size="lg" variant="outline" asChild>
                  <a
                    href="https://github.com/phinehas1999/property-management-system"
                    target="_blank"
                  >
